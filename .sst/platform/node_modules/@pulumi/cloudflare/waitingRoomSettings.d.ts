 ...
 * ```
 */
export declare class WaitingRoomSettings extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WaitingRoomSettingsState, opts?: pulumi.CustomResourceOptions): WaitingRoomSettings;
    /**
     * Returns true if the given object is an instance of WaitingRoomSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WaitingRoomSettings;
    /**
