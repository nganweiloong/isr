...
exports.getRateLimitsOutput = exports.getRateLimits = void 0;
 ...
 * ```
 */
function getRateLimits(args, opts) {
 ...
 * ```
 */
function getRateLimitsOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getRateLimitsOutput = getRateLimitsOutput;
//# sourceMappingURL=getRateLimits.js.map