 ...
 * ```
 */
export declare class MtlsCertificate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MtlsCertificateState, opts?: pulumi.CustomResourceOptions): MtlsCertificate;
    /**
     ...
     */
    readonly ca: pulumi.Output<boolean>;
    /**
