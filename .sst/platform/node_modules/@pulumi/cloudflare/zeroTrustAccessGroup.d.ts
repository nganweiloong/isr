 ...
 * ```
 */
export declare class ZeroTrustAccessGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustAccessGroupState, opts?: pulumi.CustomResourceOptions): ZeroTrustAccessGroup;
    /**
     ...
     */
    readonly excludes: pulumi.Output<outputs.ZeroTrustAccessGroupExclude[] | undefined>;
    /**
